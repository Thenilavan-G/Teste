...
import static AdminPages.AdminTestBase.test2;
...
//    By testtype2 = By.xpath("//div/div/div/div[2]/div[1]/table/tbody/tr[2]/td[7]/span/img[@src='../../assets/img/home test icon.png']");
    ...
    public void verifyCompletedOrderCount() throws IOException {
    ...
    public void verifyCompletedText() throws IOException {
    ...
    public void verifyApprovedOrderCount() throws IOException {
    ...
    public void verifyApprovedText() throws IOException {
    ...
    public void verifyAgeHeader() throws IOException {
    ...
    public void verifySexHeader() throws IOException {
    ...
    public void verifyPhoneNoHeader() throws IOException {
    ...
    public void verifyLocationHeader() throws IOException {
    ...
    public void verifyFirstOrderPatientAge() throws IOException {
    ...
    public void verifyFirstOrderPatientPhoneNo() throws IOException {
    ...
    public void verifyFirstOrderPatientTestType() throws IOException {
        ...
        try {
            ...
            test2.log(LogStatus.WARNING, "Test type not visible");
            getScreenshot("testtype_1");
        }
    }
