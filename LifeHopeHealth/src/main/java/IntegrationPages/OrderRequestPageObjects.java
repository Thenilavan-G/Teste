...
import static IntegrationPages.TestBaseAdmin.test4;
...
public class OrderRequestPageObjects {
    ...
    By readHomePageTestType = By.xpath("/html/body/app-root/div[1]/div/div[3]/app-order-list/div/app-life-hope-table/div/div/div/div[2]/div[1]/table/tbody/tr/td[7]/span/img");
    By s_readHomePageTestType = By.xpath("/html/body/app-root/div[1]/div/div[3]/app-order-list/div/app-life-hope-table/div/div/div/div[2]/div[1]/table/tbody/tr/td[7]/img");
    ...
    By readTestTypee = By.xpath("/html/body/app-root/div[1]/div/div[3]/app-approve-status/section/div/div/div[2]/div/div[1]/div[1]/div[2]/img");
    ...
    public void readHomePageProfileImage() throws IOException {
        try {
            ...
            test4.log(LogStatus.FAIL, "HomePage-Patient Profile Image is not Displayed");
    ...
    public void readHomePageTestOrderType() throws IOException {
        try {
            ...
            try {
                test4.log(LogStatus.INFO, "Verify HomePage-Test Order Type");
                WebElement HomePageTestType = new WebDriverWait(driver, 2)
                        .until(driver -> driver.findElement(s_readHomePageTestType));
                String Text = HomePageTestType.getAttribute("src");
                //System.out.println(Text);
                //driver.findElement(readHomePageTestType);
                if (Text.contains("home%")) {
                ...
                test4.log(LogStatus.FAIL, "Test order type is not displayed");
                getScreenshot("HomePage-TestOrderType");
            }
        }
    }
    ...
    public void clickOrder() throws IOException {
        try {
            ...
            WebElement ClickOrder = new WebDriverWait(driver, 1)
    ...
    public void readAddonMember() throws InterruptedException, IOException {
        ...
        try {
            ...
            if (driver.findElement(readAddonMember).isDisplayed()) {
                ...
                test4.log(LogStatus.SKIP, "Add on Member 1 is not Added");
                //getScreenshot("AddOnMembers1");
            }
        } catch (NoSuchElementException | TimeoutException e) {
            test4.log(LogStatus.SKIP, "Add on Members are not Added");
        }
    }
    ...
    public void readAddonMember2() throws IOException, InterruptedException {
        try {
            ...
            if (driver.findElement(readAddonMember2).isDisplayed()) {
                ...
                test4.log(LogStatus.SKIP, "Add on Member2 Details not Displayed");
    ...
    public void readAddonMember3() throws IOException, InterruptedException {
        try {
            ...
            if (driver.findElement(readAddonMember3).isDisplayed()) {
                ...
                test4.log(LogStatus.SKIP, "Add on Member3 Details not Displayed");
    ...
    public void readAddonMember4() throws IOException, InterruptedException {
        try {
            ...
            if (driver.findElement(readAddonMember4).isDisplayed()) {
                ...
                test4.log(LogStatus.SKIP, "Add on Member4 Details not Displayed");
    ...
    public void readTestType() throws InterruptedException, IOException {
        try {
            ...
            if (t.contains("home")) {
                ...
                test4.log(LogStatus.FAIL, "Test type not visible");
    ...
    //Click Approve
    public void clickApprove() throws IOException {
        try {
            Thread.sleep(2000);
            test4.log(LogStatus.INFO, "Clicking Test Order Approve");
            WebElement ClickAprrove = new WebDriverWait(driver, 10)
    ...
    public void readApproveAlertMessage() throws IOException {
        try {
            ...
            if (Text.equals("null") || Text.isEmpty()) {
                test4.log(LogStatus.SKIP, "Approve Alert Message is not displayed ");
    ...
    public void clickApproveConfirm() throws IOException {
        try {
            ...
            WebElement ConfirmApprove = new WebDriverWait(driver, 5)
...
//            String Name = driver.findElement(readHomePagePatientName).getText();
//            test4.log(LogStatus.PASS, "Name: " + Name);
//            String Age = driver.findElement(readHomePagePatientAge).getText();
//            test4.log(LogStatus.PASS, "Age: " + Age);
//            String Gender = driver.findElement(readHomePagePatientSex).getText();
//            test4.log(LogStatus.PASS, "Gender: " + Gender);
//            String Phone = driver.findElement(readHomePagePatientPhone).getText();
//            test4.log(LogStatus.PASS, "Phone: " + Phone);
//            String Location = driver.findElement(readHomePagePatientLocation).getText();
//            test4.log(LogStatus.PASS, "Location: " + Location);
//            String Test = driver.findElement(readHomePageTestDetails).getText();
//            test4.log(LogStatus.PASS, "Test: " + Test);
        } catch (NoSuchElementException | TimeoutException e) {
    ...
    public void readCopyright() throws IOException {
        try {
            ...
            WebElement CR = new WebDriverWait(driver, 20)
