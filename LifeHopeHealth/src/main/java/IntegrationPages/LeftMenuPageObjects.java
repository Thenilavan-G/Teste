...
import static IntegrationPages.TestBaseApp.test21;
...
public class LeftMenuPageObjects {
    ...
    public void clickContactSupport() throws InterruptedException, IOException {
        ...
        try {
            clickDashboardMenu();
            Thread.sleep(2000);
            driver.findElement(contact_support).click();
    ...
    public void clickTermsAndConditions() throws InterruptedException, IOException {
        ...
        try {
            ...
            new TouchAction((PerformsTouchActions) driver)
                    ...
                    .release().perform();
            Thread.sleep(5000);
            driver.findElement(back_icon3).click();
        } catch (NoSuchElementException e) {
    ...
    public void clickPrivacyPolicy() throws InterruptedException, IOException {
        ...
        try {
            ...
            new TouchAction((PerformsTouchActions) driver)
                    ...
                    .release().perform();
            Thread.sleep(5000);
            driver.findElement(back_icon2).click();
        } catch (NoSuchElementException e) {
