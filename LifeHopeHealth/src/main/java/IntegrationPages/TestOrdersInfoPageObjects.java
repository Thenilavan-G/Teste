...
import static IntegrationPages.TestBaseApp.test14;
...
//            driver.findElement(test_orders).click();
    ...
    public void verifyTestOrdersTitle() throws IOException {
        ...
        try {
//            Thread.sleep(5000);
//            String title = driver.findElement(test_orders_head).getText();
            WebElement payProceed = new WebDriverWait(driver, 30)
                    .until(driver -> driver.findElement(test_orders_head));
            String title = payProceed.getText();
    ...
    public void verifyTestOrders() throws IOException, InterruptedException {
        try {
            ...
            Thread.sleep(5000);
            String data = driver.findElement(test_no_data).getText();
            if (data.equals("null")) {
    ...
    public void verifyTestImage() throws IOException {
        try {
            //Thread.sleep(2000);
            WebElement payProceed = new WebDriverWait(driver, 2)
    ...
    public void verifyTestName() throws InterruptedException, IOException {
        try {
            //Thread.sleep(2000);
            WebElement payProceed = new WebDriverWait(driver, 1)
    ...
    public void verifyTestPrice() throws IOException {
        ...
        try {
            ...
            if (payProceed.isDisplayed()) {
                ...
                if (schedPrice.contains("$")) {
                    test14.log(LogStatus.PASS, "Test Order Price is : " + schedPrice);
                } else if (schedPrice.equals("null") || schedPrice.isEmpty()) {
                    test14.log(LogStatus.WARNING, "Test Price is not visible: " + schedPrice);
                } else {
                    test14.log(LogStatus.PASS, "Test Order Price is Visible : " + schedPrice);
                }
            } else {
    ...
    public void verifyTestType() throws InterruptedException, IOException {
        try {
            //Thread.sleep(2000);
            WebElement payProceed = new WebDriverWait(driver, 1)
    ...
    public void verifyOrderStatus() throws InterruptedException, IOException {
        try {
            //Thread.sleep(2000);
            WebElement payProceed = new WebDriverWait(driver, 1)
    ...
    public void verifyOrderId() throws InterruptedException, IOException {
        try {
            ...
            if (payProceed.isDisplayed()) {
                ...
                test14.log(LogStatus.PASS, orderId);
            } else {
    ...
    public void gotoTestInfo() throws IOException {
        try {
            ...
            //String testName = driver.findElement(test_orders_head).getText();
            //System.out.println(testName);
            //Thread.sleep(2000);
            payProceed.click();
            //Thread.sleep(2000);
            WebElement payProceed1 = new WebDriverWait(driver, 5)
    ...
    public void verifyPaymentHeader() throws IOException {
        try {
            ...
            String paymentHeader = payProceed.getText();
    ...
    public void verifyTotalNameAndPrice() throws IOException {
        try {
            ...
            String tot = payProceed1.getText();
            ...
            //Thread.sleep(2000);
            WebElement payProceed4 = new WebDriverWait(driver, 1)
                    .until(driver -> driver.findElement(total_price));
            if (payProceed4.isDisplayed()) {
    ...
    public void verifyAddOnMember() throws InterruptedException, IOException {
        ...
        try {
            ...
            WebElement payProceed = new WebDriverWait(driver, 1)
                    .until(driver -> driver.findElement(test_count));
            String testCount = payProceed.getText();
            //System.out.println(testCount);
            //Thread.sleep(2000);
            WebElement payProceed1 = new WebDriverWait(driver, 1)
                    .until(driver -> driver.findElement(arrow));
            payProceed1.click();
            //Thread.sleep(5000);
            WebElement payProceed2 = new WebDriverWait(driver, 2)
                    .until(driver -> driver.findElement(info_icon));
            payProceed2.click();
            //Thread.sleep(2000);
            WebElement payProceed3 = new WebDriverWait(driver, 1)
                    .until(driver -> driver.findElement(addon_header));
            String addHeader = payProceed3.getText();
            ...
            if (testCount.contains("+1")) {
                //Thread.sleep(2000);
                WebElement pay = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_name_first));
                String patientName = pay.getText();
                ...
                //Thread.sleep(2000);
                WebElement pay1 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_age_first));
                String patientAge = pay1.getText();
                ...
                //Thread.sleep(2000);
                WebElement pay2 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_gender_first));
                String patientGender = driver.findElement(patient_gender_first).getText();
                ...
                WebElement pay2 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_gender_first));
                String patientGender = pay2.getText();
                //System.out.println(patientGender);
                if (patientGender.contains("null")) {
                ...
                WebElement pay3 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_name_second));
                String patientName2 = pay3.getText();
                ...
                WebElement pay4 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_age_second));
                String patientAge2 = pay4.getText();
                ...
                WebElement pay5 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_gender_second));
                String patientGender2 = pay5.getText();
                ...
                WebElement pay6 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_name_third));
                String patientName3 = pay6.getText();
                ...
                WebElement pay7 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_age_third));
                String patientAge3 = pay7.getText();
                ...
                WebElement pay8 = new WebDriverWait(driver, 1)
                        .until(driver -> driver.findElement(patient_gender_third));
                String patientGender3 = pay8.getText();
            ...
            String patientName4 = pay.getText();
            ...
            String patientAge4 = pay1.getText();
            ...
            String patientGender4 = pay2.getText();
