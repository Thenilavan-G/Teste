...
public class TestBaseApp extends IntegrationGoogleSheet {
    ...
    public static void launchApp() throws MalformedURLException {
        ...
        //File app = new File("./app/LifeHope 25-01-2021.apk");
...
//        driver.startRecordingScreen(new BaseStartScreenRecordingOptions(....));
    ...
    public static void startTest() {
        ...
        File dir1 = new File("./LH_App_Integration_Report_" + currentDate + "/FailedTestScreenshots");
        dir1.mkdir();
        ...
        report = new ExtentReports("./LH_App_Integration_Report" + "_" + currentDate + "/LH_App_Integration_Report_" + currentDate + ".html");
    ...
    public static void getScreenshot(String screenshotname) throws IOException {
        ...
        String destinationFile = "./LH_App_Integration_Report_"+ currentDate + "/FailedTestScreenshots/" + screenshotname + ".jpg";
