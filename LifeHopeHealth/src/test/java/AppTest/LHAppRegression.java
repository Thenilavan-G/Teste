...
public class LHAppRegression extends AppTestBase {

    @Test
    public static void Login_Page_UI() throws IOException {
    ...
    public static void MobileNumber_Signup() throws InterruptedException, IOException {
        ...
        mobileObj.verifyMobileNumber("2000000004");
    }
    ...
    public static void Facebook_MobileNumber_Signup() throws InterruptedException, IOException {
        ...
        fbObj.verifyUI("Enter your mobile number to \n" + "Login or Sign up", "Mobile Number", "+1", "Next", dataList.get(10), "Verification code has been sent to \n" + " +91 1800000000");
    ...
    public static void Gmail_Signup() throws InterruptedException, IOException {
        ...
        gObj.verifyUI("Enter your mobile number to \n" + "Login or Sign up", "Mobile Number", "+91", "Next", dataList.get(10));
    ...
    @Test
    public static void Home_Screen_UI() throws IOException {
