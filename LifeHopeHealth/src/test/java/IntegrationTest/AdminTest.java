...
import IntegrationPages.TestBaseAdmin;
import org.testng.annotations.*;

import java.io.IOException;

@Listeners(TestNGListeners.class)
public class AdminTest extends TestBaseAdmin {
...
//        reqObj.readOrderRequestHeader();
        reqObj.setSearchBy(dataList.get(22));
...
//        reqObj.clickApproveClose();
        reqObj.setOrderConfirmation(dataList.get(20), dataList.get(21));
    }
    ...
    public static void OrderTrack() throws IOException {
        ...
        //RecentOrderView();
        ordTrack.selectOrders(dataList.get(22));
    ...
    public static void TestOrders() throws IOException, InterruptedException {
        ...
        TestOrderObj.setSearchBy(dataList.get(22));
